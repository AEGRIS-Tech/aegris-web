  ...
  async function runAnalysis() {
    ...
    try {
      ...
      const historyResponse =
        await fetch(
          `/api/analysis/history?latitude=${project.latitude}&longitude=${project.longitude}&projectId=${project.id}`
        );
              ...
              <div>
                ...
                <div className="mt-4 grid grid-cols-3 overflow-hidden rounded-lg border border-slate-800">
                  ...
                  <div className="bg-[#061022] p-3">
                    ...
                    <div className="mt-1 text-2xl font-black text-orange-400">{contextEvaluation.level === "Kritické" ? "Kritické" : contextEvaluation.level === "Upozornění" ? "Zvýšené" : contextEvaluation.level === "Bez vyhodnocení" ? "—" : "Nízké"}</div>
                  </div>
                </div>
