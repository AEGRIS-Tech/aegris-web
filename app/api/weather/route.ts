...
export async function GET(request: NextRequest) {
  ...
  if (
    ...
    return NextResponse.json(
      {
        error: "Neplatné souřadnice projektu.",
      },
      {
        status: 400,
      }
